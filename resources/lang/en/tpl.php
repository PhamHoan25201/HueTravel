...
return [
    ...
    */
    ...
    'newstype.index.status' => 'Featured',
    'newstype.index.status.hidden' => '-',
    'newstype.index.status.show' => 'Featured',
