@extends('layouts.app')	
	...
	@foreach ($listCategory as $category)
		<?php 
			$listTin = $category->news->where('tin_noi_bat',1)->sortByDesc('created_at')->take(5);
		?>
		      ...
		      <div class="col-md-8 text-left">
		        <div class="row">
		          <div class="col-md-12">        
		            ...
		            <h1 class="page-title">Thể loại: {{$category->name}}</h1>
		            <p class="page-subtitle">Hiển thị tất cả các tin với thể loại <i>"{{$category->name}}"</i></p>
		          </div>
		        </div>
		        <div class="line"></div>
		        <div class="row">
