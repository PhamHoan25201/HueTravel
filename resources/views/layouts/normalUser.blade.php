...
<html>
	<head>
		...
		<link rel="stylesheet" href="{{asset('NormalUser/scripts/ionicons/css/ionicons.min.css')}}">  <!-- IonIcons -->
		<link rel="stylesheet" href="{{asset('NormalUser/scripts/toast/jquery.toast.min.css')}}">  <!-- Toast -->
		<link rel="stylesheet" href="{{asset('NormalUser/scripts/owlcarousel/dist/assets/owl.carousel.min.css')}}">  <!-- OwlCarousel -->
		<link rel="stylesheet" href="{{asset('NormalUser/scripts/owlcarousel/dist/assets/owl.theme.default.min.css')}}">
		<link rel="stylesheet" href="{{asset('NormalUser/scripts/magnific-popup/dist/magnific-popup.css')}}">  <!-- Magnific Popup -->
		<link rel="stylesheet" href="{{asset('NormalUser/scripts/sweetalert/dist/sweetalert.css')}}">
		<link rel="stylesheet" href="{{asset('NormalUser/css/style.css')}}">  <!-- Custom style -->
				...
				<div class="container">
					<div class="row">
						<div class="col-md-3 col-sm-12">
							<div class="brand">
								<a href="index.html">
									<img src="{{asset('NormalUser/images/logo.png')}}" alt="Magz Logo">
								</a>
							</div>						
						</div>
						...
						<div class="owl-carousel owl-theme slide" id="featured">
							<div class="item">
								<article class="featured">
									...
									<figure>
										<img src="{{asset('NormalUser/images/news/img04.jpg')}}" alt="Sample Article">
									</figure>
									<div class="details">
